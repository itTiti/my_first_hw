...
# print(a) ### Мучилась с count, так и не решила, ответ подсмотрела у тебя. В душе не знала, что max имеет другие аргументы :)
...
#
# c = [ls for ls in a + b]
# print(c) ## Сама в шоке, но работает :D писала а + b (с мыслью, а вдруг сработает) :D
